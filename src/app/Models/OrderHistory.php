...
class OrderHistory extends Model
{
    ...
    public function orderHistory($request) {
        ...
        ->select(
            ...
            'orders.uuid',
            'orders.user_id',
            'orders.order_total_amount AS orders_table_total_amount',
            'orders.order_total_number AS orders_table_total_number',
            'order_details.order_total_number AS orders_details_table_total_number',
            'orders.created_at',
            'order_details.filename',
            'order_details.price',
            'order_details.url',
            'order_details.order_id',
            'order_details.photo_id',
