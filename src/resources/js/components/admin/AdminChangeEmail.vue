<template>
    <section class="adminchangeemail">
        ...
        <div class="adminchangeemail_wrap">
            ...
            <form method="post" class="adminchangeemail_wrap_form" @submit.prevent="clickRegister">
                <!-- laravelのトークンを使用 -->
                ...
                <div class="adminchangeemail_wrap_form_line">
                    <label class="adminchangeemail_wrap_form_line_label" for="adminchangeemail_form_email">現在のメールアドレス</label>
                    <input type="text" class="adminchangeemail_wrap_form_line_input" id="adminchangeemail_form_email" v-model="changeForm.current_email">
                </div>

                <div class="adminchangeemail_wrap_form_line">
                    <label class="adminchangeemail_wrap_form_line_label" for="adminchangeemail_form_newemail">新しいメールアドレス</label>
                    <input type="text" class="adminchangeemail_wrap_form_line_input" id="adminchangeemail_form_newemail" v-model="changeForm.new_email">
                </div>

                <div class="adminchangeemail_wrap_form_line">
                    <label class="adminchangeemail_wrap_form_line_label" for="adminchangeemail_form_newemail_confirmation">新しいメールアドレス(確認)</label>
                    <input type="text" class="adminchangeemail_wrap_form_line_input" id="adminchangeemail_form_newemail_confirmation" v-model="changeForm.new_email_confirmation">
                </div>

                <div class="adminchangeemail_wrap_form_button">
                    <div class="adminchangeemail_wrap_form_button_common">
                        <ButtonRed @click="clickChangeEmail">変更する</ButtonRed>
                    </div>
                    <router-link to="/admin/mypage" class="adminchangeemail_wrap_form_button_common"><ButtonWhite>マイページトップへ戻る</ButtonWhite></router-link>
                </div>
...
export default defineComponent({
    ...
    setup() {
        ...
        const { changeEmailAdmin, resetChangeEmailMessage } = authStore;
